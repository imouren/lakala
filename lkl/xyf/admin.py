...
class SYFTerminalAdmin(admin.ModelAdmin):
    list_display = ["promotion", "merchant_receipt", "merchant_name", "agent_code", "agent_name", "sn_code", "terminal", "bind_date", "recharge_date", "recharge_status", "trade_rmb", "ok_status"]
    fields = list_display
